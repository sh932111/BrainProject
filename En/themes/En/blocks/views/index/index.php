...
<div class="card-panel grey lighten-3">
	...
	<ul id='dropdown-type' class='dropdown-content'>
		...
		?>
		<li>
			<a href="javascript: <?php echo $ctrl;?>.wordManagerBk.chooseType('<?php echo $enTypeID;?>');"><?php echo $enTypeName;?></a>
		</li>
		<?php
			}
		?>
	...
	<div class="card-panel grey lighten-4">
		...
		<a class="btn-floating btn-large waves-effect waves-light red right" href="javascript: <?php echo $ctrl;?>.wordManagerBk.addWord();">
	...
	<div class="card-panel">
		...
		<a class="waves-effect waves-light btn right" href="javascript: <?php echo $ctrl;?>.wordManagerBk.sendWord();">發送</a>
		<div class="clear"></div>
	</div>
	<?php } ?>
</div>
	    ...
	    <hr>
      	<table class="striped">
	        <thead>
	          	<tr>
	              	<th colspan="4">
	              		<input type="text" class="validate left" value="<?php echo $enWordID;?>" readOnly="true" >
	              		<h5 class="left"><?php echo $enWord;?>&nbsp;&nbsp;</h5>
	              		<a class="btn-floating btn-small waves-effect waves-light grey lighten-1 right" href="javascript: <?php echo $ctrl;?>.wordManagerBk.editWord('<?php echo $enWordID;?>');" id="edit-btn">
