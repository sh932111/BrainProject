<div class="row">
		...
		for ($i=0; $i < count($list); $i++) {
			...
			<div class="row col s6 no-margin-bottom">
				<div class="card-panel grey lighten-5 col s12 custom-card">
					...
					?>
					<a class="btn-floating yellow darken-4" href="javascript: <?php echo $ctrl;?>.testPageBk.sound(<?php echo $i;?>);">
	...
	<div class="fixed-action-btn horizontal click-to-toggle" style="bottom: 45px; right:80px;">
		<a class="btn-floating btn-large red modal-trigger"  href="javascript: <?php echo $ctrl;?>.testPageBk.upload();" id="upload-btn">上傳</a>
