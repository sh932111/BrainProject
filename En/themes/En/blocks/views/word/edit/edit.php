...
if ($error_code == 0) {
	$enWord 	= $value["value"]["enWord"];
	$enWordID 	= $value["value"]["enWordID"];
	$definitionList = $value["value"]["definitionList"];
	$exampleList 	= $value["value"]["exampleList"];
	$translateList 	= $value["value"]["translateList"];
?>
<div class="card-panel grey lighten-3">
	...
	<div class="card-panel">
		...
		<a class="waves-effect waves-light btn right" href="javascript: <?php echo $ctrl;?>.editWordBk.editWord('<?php echo $enWordID;?>');">修改</a>
		<div class="clear"></div>
	</div>
</div>
<?php	
