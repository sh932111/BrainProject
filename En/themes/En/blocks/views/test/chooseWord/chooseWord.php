		...
		<div class="col s12">
			<div class="card-panel custom-card-panel grey lighten-5 col s7">
				...
				<h6 class="brown-text text-darken-1">
					測試者：<?php echo $orderValue["userName"];?>
					&nbsp;&nbsp;
					年紀：<?php echo $orderValue["userYearOld"];?>&nbsp;歲
				</h6>
				<h6 class="brown-text text-lighten-1">
					單字數：<?php echo $orderValue["wordNum"];?>&nbsp;個
					&nbsp;&nbsp;
					測驗時間：<?php echo $orderValue["testTime"];?>&nbsp;秒
				</h6>
				<h5 class="red-text text-lighten-1 custom-font-size" id="word-num-text">
					已選擇：<?php echo $alreadyWord?>個單字
					<?php
					if ($alreadyWord == $orderValue["wordNum"]) {
						?>
						，如已經確認完畢，請按下上方送出按鈕！
						<?php	
					}
				...
				<div class="card-panel grey lighten-5 col s12">
					...
					for ($x=0; $x < count($list); $x++) {
						...
						<div class="card-panel text-card-panel grey lighten-5 left margin-rigth-10" id="box-<?php echo $x;?>">
							<a class="left waves-effect waves-light white" id="btn-<?php echo $x;?>" href="javascript: <?php echo $ctrl;?>.chooseBk.removeWord('<?php echo $detailID;?>',<?php echo $x;?>);">
			...
			for ($i=0; $i < count($wordList); $i++) {
				...
				<div class="col s6">
					<div class="card-panel custom-card-panel grey lighten-5">
						...
						<a class="btn-floating btn-large waves-effect waves-light teal lighten-1" href="javascript: <?php echo $ctrl;?>.chooseBk.addWord('<?php echo $orderID;?>','<?php echo $enWordID;?>',<?php echo $index;?>);" id="btn-<?php echo $index;?>">
