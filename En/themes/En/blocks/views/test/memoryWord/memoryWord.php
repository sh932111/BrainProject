	...
	<div class="col s12">
		<div class="card style-color">
			<div class="card-content" id="word-box">
				...
				<a class="btn-floating btn-large yellow darken-4 left" href="javascript: <?php echo $ctrl;?>.memoryBk.sound();">
					<i class="large material-icons">volume_up</i>
				</a>
				<a class="btn grey lighten-3 style-text-color right" href="javascript: <?php echo $ctrl;?>.memoryBk.google();">Google</a>
				<a class="btn grey lighten-3 style-text-color right margin-right-10" href="javascript: <?php echo $ctrl;?>.memoryBk.doTest();" id="self-test">自行測試</a>
				<div class="clear"></div>
			</div>
			<div class="card-action" id="do-test">
				...
				<a class="btn grey lighten-3 style-text-color right" href="javascript: <?php echo $ctrl;?>.memoryBk.hideTest();">忘記了</a>
				<a class="btn grey lighten-3 style-text-color right margin-right-10" href="javascript: <?php echo $ctrl;?>.memoryBk.confirm();">確認答案</a>
				<div class="clear"></div>
			</div>
			...
			<div class="card-action">
				<div id="left-controller" class="left">
					<a class="waves-effect waves-light btn left grey lighten-3" href="javascript: <?php echo $ctrl;?>.memoryBk.back();">
				...
				<div id="right-controller" class="right">
					<a class="waves-effect waves-light btn right grey lighten-3" href="javascript: <?php echo $ctrl;?>.memoryBk.next();">
